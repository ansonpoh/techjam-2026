...
from starter.product_features import BUDGET_RE, FACET_PATTERNS, terms
from starter.vector_index import catalog_sha256
...
class ConstraintIndex:
    ...
    def add_product(self, product: Mapping[str, object]) -> None:
        ...
        # The simulator describes a product using the last two taxonomy nodes.
